...
As an example, [@lmassaron](https://github.com/lmassaron) (Lucas Massaron)'s [Kaggle notebook](https://www.kaggle.com/lucamassaron) "Fine-tune Llama 2 for sentiment analysis" is a good way to begin and understand the procedure.
